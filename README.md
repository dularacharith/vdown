...
- **Universal Link Support**: Downloads from YouTube, Facebook, Instagram, TikTok (without watermark), Spotify, TIDAL, Apple Music, Twitter/X, Vimeo, Reddit, Twitch, and 1800+ other platforms.
- **Apple Music Lossless Audio**: Extract official Apple Music metadata, songs, albums, and playlists in studio-quality **Lossless FLAC**, **WAV PCM**, or **320 kbps MP3** with embedded 1400x1400 artwork.
...
### 8. Apple Music Songs, Albums & Playlists (Lossless FLAC, WAV, 320k MP3)
Official Apple Music catalog metadata extraction with 1400x1400 high-res artwork, duration proximity matching, and transcoding into bit-perfect Lossless FLAC, uncompressed WAV, or 320 kbps MP3:

```bash
# Download Apple Music song as Studio Lossless FLAC with embedded 1400x1400 artwork
vdown "https://music.apple.com/us/album/better-together/1440857781?i=1440857786" --audio-format flac

# Download Apple Music song as uncompressed Lossless WAV with native ID3v2 APIC splash art
vdown "https://music.apple.com/us/album/better-together/1440857781?i=1440857786" --audio-format wav

# Download Apple Music song as 320 kbps MP3
vdown "https://music.apple.com/us/song/better-together/1440857786" --audio-format mp3 -aq 320

# Download full Apple Music Album into organized folder with track numbering and cover.jpg
vdown "https://music.apple.com/us/album/in-between-dreams-bonus-track-version/1440857781" --audio-format flac

# Download specific track range from an Apple Music Playlist
vdown "https://music.apple.com/us/playlist/apple-music-list/pl.41fda5adbf9b4db4ba1a2c0a76099ef9" --playlist-items 1-10 --audio-format flac
```

### 9. Choose Video Resolution (e.g. 4K, 1080p, or 720p)
```bash
vdown "https://www.youtube.com/watch?v=..." -q 1080p
```

### 10. TikTok (No Watermark & Photo Slideshows)
```bash
...
### 11. Instagram & Facebook (With Browser Session)
```bash
vdown "https://www.instagram.com/reel/.../" --browser chromium
vdown "https://www.facebook.com/reel/..." --browser chromium
```

### 12. Inspect Link Details & Available Formats
```bash
vdown "https://..." --info
```

### 13. Custom Output Directory & File Name
```bash
